...
//    }
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        print("STORED PERIPHERAL COUNT = \(storedPeripherals.count)")
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        peripheralManager = storedPeripherals[indexPath.row]
...
//        cell.detailTextLabel?.textColor = UIColor.black
        if let cell = tableView.dequeueReusableCell(withIdentifier: "", for: indexPath) as? PeripheralCell {
            let peripheralCell = storedPeripherals[indexPath.row]
